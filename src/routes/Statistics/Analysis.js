...
const totalOverview = <Fragment><div>上线时间：2019-02-20 14:17:02     统计范围：当前商户</div><div>总销售额：上线至更新时间，客户购买商品的合计金额</div><div>总订单数：上线至更新时间，成功支付的订单数</div><div>会员总数：上线至更新时间，注册的用户总数</div><div>付费盟主会员数：上线至更新时间，客户成功支付升级为盟主的会员数</div><div>免费盟主会员数：上线至更新时间，后台设置为盟主的会员数</div><div>付费群主会员数：上线至更新时间，客户成功支付升级为群主的会员数</div><div>免费群主会员数：上线至更新时间，后台设置为群主的会员数</div></Fragment>; // 今日概况
const overview = <Fragment><div>今日销售额：今日零时至更新时间，客户购买商品的合计金额</div><div>今日订单数：今日零时至更新时间，成功支付的订单数</div><div>今日商品订单数：今日零时至更新时间，成功支付的普通订单数和拼团订单数</div><div>今日盟主订单数：今日零时至更新时间，成功支付升级为盟主的订单数</div><div>今日群主订单数：今日零时至更新时间，成功支付升级为群主的订单数</div><div>今日补差价升级：今日零时至更新时间，群主客户成功支付升级为盟主的订单数</div><div>今日佣金：今日零时至更新时间，合计产生的佣金总额</div><div>今日会员数：今日零时至更新时间，新注册的用户数</div></Fragment>; // 今日概况
    ...
    return (
      <Fragment>
        ...
        <div className={styles.cardInfo}>
          ...
          <div  className={styles.txtCenter}>
            <div className={styles.txtTitle}>盟主<Popover title="数据组成说明"  overlayClassName={styles.txtTip} content="含群主[补差价]+店主[补差价]+正常升级"><Icon type='question-circle' /></Popover></div>
          ...
          <div  className={styles.txtCenter}>
            <div className={styles.txtTitle}>店主<Popover title="数据组成说明"  overlayClassName={styles.txtTip} content="含群主[补差价]+正常升级"><Icon type='question-circle' /></Popover></div>
          ...
          {/* <div className={styles.txtCenter}>
            <div className={styles.txtTitle}>群主补差价升级盟主</div>
          ...
          <div className={styles.txtCenter}>
            <div className={styles.txtTitle}>店主补差价升级盟主</div>
          ...
          {/* <div  className={styles.txtCenter}>
            <div className={styles.txtTitle}>补差价店主</div>
