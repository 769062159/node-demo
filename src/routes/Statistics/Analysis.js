...
const totalOverview = <Fragment><div>上线时间：2019-02-20 14:17:02</div><div>总销售额：上线至更新时间，客户购买商品的合计金额</div><div>总订单数：上线至更新时间，成功支付的订单数</div><div>会员总数：上线至更新时间，注册的用户总数</div><div>付费导师会员数：上线至更新时间，客户成功支付升级为导师的会员数</div><div>免费导师会员数：上线至更新时间，后台设置为导师的会员数</div><div>付费群主会员数：上线至更新时间，客户成功支付升级为群主的会员数</div><div>免费群主会员数：上线至更新时间，后台设置为群主的会员数</div></Fragment>; // 今日概况
